...
class App extends Component {
  ...
  renderTabList = () => {
    return (
      <div className="my-5 tab-list text-center">
  ...
  renderItems = () => {
    ...
    return newItems.map(item => (
      <li key={item.id} className="list-group-item d-flex justify-content-between align-items-center" >
        ...
        <span>
          <button onClick={() => this.editItem(item)} className="btn btn-secondary mr-2 theedit" >Edit</button>
        ...
        <div className="row ">
          <div className="col-md-6 col-sm-10 mx-auto p-0">
            <div className="card p-3">
              ...
              {this.renderTabList()}
              <ul className="list-group list-group-flush therender">
                {this.renderItems()}
              </ul>
            </div>
          </div>
        </div>
        <footer className='my-5 mb-4 bg-info text-center thefooter'>Copyright 2023 &copy; by Abdelmaksoud</footer>
        {this.state.modal ? (
